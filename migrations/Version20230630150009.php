 ...
 */
final class Version20230630150009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE modem (id INT NOT NULL, slave_modem_id INT DEFAULT NULL, model VARCHAR(255) NOT NULL, serial VARCHAR(255) NOT NULL, ip VARCHAR(255) NOT NULL, structured_cable LONGTEXT NOT NULL, inventory VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A092424F48527A53 (slave_modem_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
