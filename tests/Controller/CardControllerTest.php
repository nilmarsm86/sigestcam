...
class CardControllerTest extends WebTestCase
{
    ...
    public function testShow(): void
    {
        $this->markTestIncomplete();
        $fixture = new Card();
        $fixture->setSlot('My Title');
        $fixture->setName('My Title');
        $fixture->setMsam('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'card[slot]' => 'Something New',
            'card[name]' => 'Something New',
            'card[msam]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getSlot());
        self::assertSame('Something New', $fixture[0]->getName());
        self::assertSame('Something New', $fixture[0]->getMsam());
    }
